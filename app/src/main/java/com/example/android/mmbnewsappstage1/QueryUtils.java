...
public final class QueryUtils {
    ...
    private static List<NewsObject> extractFeatureFromJson(String newsJSON) {
        ...
        try {
            ...
            // For each news in the newsArray, create an {@link NewsObject} object
            for (int i = 0; i < newsArray.length(); i++) {
                ...
                // Create a new {@link NewsObject} object with category, date, title, url time,
                // from the JSON response.
                NewsObject newNews = new NewsObject(title, category, date, url);

                // Add the new {@link NewsObject} to the list of news.
                news.add(newNews);
            }
